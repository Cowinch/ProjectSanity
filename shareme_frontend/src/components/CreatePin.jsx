...
//the select and option menu on this page throws a gigantic error message, even though everything works correctly???
                    ...
                    <div className='flex justify-center items-center flex-col border-2 border-dotted border-gray-300 p-3 w-full h-420'>
                        ...
                        {!imageAsset ? (
                            ...
                            <label className='w-full h-full'>
                                <div className='flex flex-col items-center justify-center h-full cursor-pointer p-3'>
